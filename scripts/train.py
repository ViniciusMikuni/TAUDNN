...
parser.add_argument('--data_dir', default='/pnfs/psi.ch/cms/trivcat/store/user/vmikuni/TAU', help='directory with data [default: hdf5_data]')
parser.add_argument('--nfeat', type=int, default=13, help='Number of features PF [default: 16]')
parser.add_argument('--ncat', type=int, default=6, help='Number of categories [default: 2]')
parser.add_argument('--year', type=int, default=17, help='Year')
